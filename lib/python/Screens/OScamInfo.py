...
class OSCamInfo(Screen, OSCamGlobals):
	...
	def updateOScamData(self):
		...
		# ctime = datetime.now(timezone.utc).astimezone().isoformat()
		...
		if webifok and result:
			...
			self["timerinfos"].setText('')  # set at least one element just for having the attribute 'activeComponents'
